...
class Items {
	...
	public function count_items_search($string) {
		$s = "%$string%";
		$prepared = $this->prepare("SELECT COUNT(*) as c FROM items WHERE id LIKE ? OR name LIKE ? OR descrp LIKE ? OR date_added LIKE ? OR category IN (SELECT id FROM kategori WHERE name LIKE ?)", 'count_items_search()');
	...
	public function search($string, $page, $items_per_page) {
		...
		$prepared = $this->prepare("SELECT * FROM items WHERE id LIKE ? OR name LIKE ? OR descrp LIKE ? OR date_added LIKE ? OR category IN (SELECT id FROM kategori WHERE name LIKE ?) ORDER BY id DESC LIMIT $x,$y", 'search()');
	...
	public function get_category_name($id) {
		$prepared = $this->prepare("SELECT name FROM kategori WHERE id=?", 'get_category_name()');
