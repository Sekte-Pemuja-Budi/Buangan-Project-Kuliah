...
<div id="header">
			...
			<div class="right">
				...
				?>
				<a href="settings.php" title="Settings">Pengaturan</a>|
		...
		<div id="menu">
			<ul id="menuli">
				...
				if($headrole == 4){
				?>
				<li<?php if($_page == 3) { ?> class="active"<?php } ?>><a href="items.php" title="Items"><i class="fa fa-list-ul"></i> List Kegiatan</a></li>
				...
				?>
				<li<?php if($_page == 3) { ?> class="active"<?php } ?>><a href="items.php" title="Items"><i class="fa fa-list-ul"></i> List Kegiatan</a></li>
				<li<?php if($_page == 2) { ?> class="active"<?php } ?>><a href="new-item.php" title="New Item"><i class="fa fa-plus"></i> Tambah Kegiatan</a></li>
				<li<?php if($_page == 4) { ?> class="active"<?php } ?>><a href="check-in.php" title="Check-In Item"><i class="fa fa-arrow-down"></i> Berkas</a></li>
				<?php
				}
				?>
				...
				?>
				<li<?php if($_page == 7) { ?> class="active"<?php } ?>><a href="categories.php" title="Categories"><i class="fa fa-folder"></i> Kategori</a></li>
			</ul>
		</div>